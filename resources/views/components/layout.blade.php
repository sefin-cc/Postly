...
<body class="bg-slate-100 text-slate-900">
    <header class="bg-slate-800 shadow-lg">
        <nav>
            <a class="text-2xl text-white font-black" href="{{ route('posts.index') }}" class="nav-link">Post.ly</a>
            
            @auth
                <div  class="relative grid place-items-center" x-data="{ open: false }">
                    <button @click="open = !open" type="button" class="round-btn">
                        <img src="https://res.cloudinary.com/dqp0ejscz/image/upload/blank-profile-picture-973460_1280_idgyn3.png" alt="" />
                    </button>

                    <div x-show="open" class="bg-white shadow-lg absolute top-12 right-0 rounded-lg overflow-hidden font-light p-1">
